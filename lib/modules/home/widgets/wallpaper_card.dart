                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Obx(() {
                      ...
                      final isDownloading = controller.downloadingIds.containsKey(wallpaper.id);
                      final progress = controller.downloadingIds[wallpaper.id] ?? 0.0;

                      return Material(
                        color: Colors.transparent,
                        child: InkWell(
                          onTap: () => controller.downloadWallpaper(wallpaper),
